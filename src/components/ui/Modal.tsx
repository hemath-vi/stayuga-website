...
export function Modal({
  ...
  /**
   * `useSyncExternalStore` gives us SSR-safe values with no setState-in-effect
   * cascade: the server snapshot is the mobile default, and the client
   * subscribes to the media query directly.
   */
