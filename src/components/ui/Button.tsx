...
const base =
  "inline-flex items-center justify-center gap-2 px-7 py-3 text-xs font-medium uppercase tracking-[0.2em] transition-colors duration-200 disabled:opacity-50 disabled:pointer-events-none";
