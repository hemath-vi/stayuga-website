 ...
 *
 * This used to be duplicated as two separate arrays (one on the home page,
 * one on /services) which had already drifted apart in both wording and
 * pricing. Both pages now read from here.
 *
